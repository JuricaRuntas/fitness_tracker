...
class MainPanel(QWidget):
  def __init__(self, parent):
    ...
    one_rep_maxes = json.loads(fetch_one_rep_maxes(self.sqlite_cursor))
    lifts_for_reps = json.loads(fetch_lifts_for_reps(self.sqlite_cursor))
  ...
  def create_time_graph(self):
    ...
    graph = OneRMGraphCanvas(self.sqlite_connection, "Horizontal Press", self.rm_history, self.current_year, self) 
  ...
  def replace_graph(self, lift_type):
    new_graph = OneRMGraphCanvas(self.sqlite_connection, lift_type, self.rm_history, self.current_year, self)
