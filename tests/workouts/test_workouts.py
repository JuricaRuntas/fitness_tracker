...
class TestWorkouts(unittest.TestCase):
  ...
  def test_fetch_workouts_table_data(self):
    os.remove("test.db")
    create_workouts_table("test.db")
    fetch_workouts_table_data(path="test.db", profile_path="test_user_profile.db")
  ...
  def test_update_workouts(self):
    ...
    update_workouts("My Workout1", new_workout, path="test.db", profile_path="test_user_profile.db")
  ...
  def test_update_current_workout(self):
    ...
    update_current_workout("My Workout1", True, path="test.db", profile_path="test_user_profile.db")
  ...
  def test_delete_workout(self):
    ...
    workout = {"My Workout1": new_workout}
    update_workouts("My Workout1", new_workout, path="test.db", profile_path="test_user_profile.db")
    delete_workout("My Workout1", path="test.db", profile_path="test_user_profile.db")
